namespace M151_WebShop.DataAccess.Migrations
{
    ...
    public partial class init : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.OrderDetails", "Articles_Id", "dbo.Articles");
            DropForeignKey("dbo.Carts", "Articles_Id", "dbo.Articles");
            ...
            DropIndex("dbo.OrderDetails", new[] { "Articles_Id" });
            DropIndex("dbo.OrderDetails", new[] { "OrderId" });
            DropIndex("dbo.Carts", new[] { "Articles_Id" });
